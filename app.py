...
def generateParaphrase():
    ...
    result, top_four_words, direct_pharses, lex_similarity, context_similarity = wat.analyse(paragraph, text)
    response = {'data': {'processed_text': result, 'frequent_words': top_four_words, "direct_phrase": direct_pharses, "lexical_similarity_index":lex_similarity, "context_similarity_index":context_similarity }}

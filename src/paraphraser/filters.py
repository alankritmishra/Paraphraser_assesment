...
class Adequacy():
  ...
  def __init__(self, model):
    self.adequacy_model = model.get_adequancy_model()
    self.tokenizer = model.get_adequacy_tokenizer()
...
class Fluency():
  def __init__(self, model):
    self.fluency_model = model.get_fluency_model()
    self.fluency_tokenizer = model.get_fluency_tokenizer()
...
class Diversity():
  ...
  def __init__(self, model):
    self.diversity_model = model.get_diversity_model()
